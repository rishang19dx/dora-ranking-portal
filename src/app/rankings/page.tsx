  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        ...
        <select className="bg-white border border-slate-200/50 rounded-xl px-4 py-2.5 text-sm font-medium text-zinc-700 shadow-sm focus:outline-none focus:border-emerald-500/50 w-full md:w-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <motion.div 
          ...
          className="bg-white border border-slate-200/50 rounded-[2rem] p-8 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] hover:border-emerald-500/30 transition-colors group"
        >
          <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-4">
            ...
            <span className="text-sm font-bold px-3 py-1.5 bg-emerald-50 text-emerald-700 rounded-lg shrink-0">Score: 82.5/100</span>
          </div>
        ...
        >
          <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-4">
            <h3 className="text-xl font-semibold text-zinc-900 flex items-center gap-3 tracking-tight">
              <div className="p-2.5 bg-zinc-100 rounded-xl text-zinc-600 group-hover:scale-110 group-hover:bg-emerald-50 group-hover:text-emerald-600 transition-all">
                <ChartBar weight="duotone" className="w-5 h-5"/>
              </div>
              Research & Practice (RPC)
            </h3>
            <span className="text-sm font-bold px-3 py-1.5 bg-emerald-50 text-emerald-700 rounded-lg shrink-0">Score: 65.2/100</span>
          </div>
          <div className="space-y-4">
            <div className="flex items-center justify-between text-sm p-4 bg-zinc-50/50 rounded-xl border border-slate-100">
