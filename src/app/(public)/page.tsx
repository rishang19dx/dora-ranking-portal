  ...
  return (
    <div className="max-w-[1200px] mx-auto px-6 py-16 space-y-24">
      ...
      <section className="text-center space-y-6 flex flex-col items-center">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="inline-block px-4 py-1.5 rounded-full bg-sage-50 text-sage-700 text-xs font-semibold tracking-wider uppercase mb-2">
          Official Data Portal
        </motion.div>
        <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="text-5xl md:text-6xl font-semibold tracking-tight text-zinc-900 max-w-3xl leading-tight font-serif">
          Automated Ranking & Data Transparency
        </motion.h1>
        <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="text-zinc-500 text-lg md:text-xl max-w-2xl leading-relaxed">
      ...
      {/* Notifications Board */}
      <section className="bg-zinc-50 border border-slate-200/50 rounded-3xl p-8 md:p-12">
